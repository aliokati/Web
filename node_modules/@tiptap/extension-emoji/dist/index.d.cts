...
//#endregion
//#region src/helpers/emojiToShortcode.d.ts
declare function emojiToShortcode(emoji: string, emojis: EmojiItem[]): string | undefined;
//#endregion
//#region src/helpers/shortcodeToEmoji.d.ts
declare function shortcodeToEmoji(shortcode: string, emojis: EmojiItem[]): EmojiItem | undefined;
//#endregion
export { Emoji, Emoji as default, EmojiItem, EmojiOptions, EmojiStorage, EmojiSuggestionPluginKey, emojiToShortcode, emojis, gitHubCustomEmojis, gitHubEmojis, inputRegex, pasteRegex, shortcodeToEmoji };
