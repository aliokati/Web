 ...
 */
export type Infer<T extends Guard<unknown> | Parser<unknown>> = T extends UnsuccessfulParser ? never : T extends Parser<infer R> ? R : T extends Guard<infer R> ? R : never;
