 ...
 */
type ExcludableStoryField = "alternates" | "created_at" | "default_full_slug" | "first_published_at" | "group_id" | "is_startpage" | "lang" | "meta_data" | "parent_id" | "path" | "position" | "published_at" | "release_id" | "sort_by_date" | "tag_list" | "taxonomy_terms" | "translated_slugs" | "updated_at";
...
declare class Storyblok {
  ...
  post(slug: string, params?: ISbStoriesParams | ISbContentMangmntAPI, fetchOptions?: ISbCustomFetch): Promise<ISbResponse>;
  put(slug: string, params?: ISbStoriesParams | ISbContentMangmntAPI, fetchOptions?: ISbCustomFetch): Promise<ISbResponse>;
  patch(slug: string, params?: ISbStoriesParams | ISbContentMangmntAPI, fetchOptions?: ISbCustomFetch): Promise<ISbResponse>;
  delete(slug: string, params?: ISbStoriesParams | ISbContentMangmntAPI, fetchOptions?: ISbCustomFetch): Promise<ISbResponse>;
