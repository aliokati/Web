 ...
 * console.log(result);
 */
declare function htmlToStoryblokRichtext(html: string, options?: HTMLParserOptions): StoryblokRichTextDoc;
//#endregion
export { type HTMLParserOptions, htmlToStoryblokRichtext, mapToAttribute };
