...
//#endregion
//#region src/test-utils/types.d.ts
...
declare const text: (content: string, marks?: RichTextMark[] | undefined) => RichTextNode;
declare const linkMark: (href: string, options?: {
  uuid?: string;
  target?: "_blank" | "_self";
...
declare const tableCell: (content: string, attrs?: {
  colspan?: number;
  rowspan?: number;
  colwidth?: number[];
  backgroundColor?: string;
}, marks?: RichTextMark[] | undefined) => RichTextNode;
declare const tableHeader: (content: string, marks?: RichTextMark[] | undefined) => RichTextNode;
declare const tableRow: (cells: RichTextNode[]) => RichTextNode;
declare const table: (rows: RichTextNode[]) => RichTextNode;
declare const doc: (content: RichTextNode | RichTextNode[]) => RichTextDoc;
//#endregion
//#region src/test-utils/integration.d.ts
declare const integrationFixtures: HtmlFixture[];
declare const customRendererFixture: Record<string, HtmlFixture>;
//#endregion
//#region src/test-utils/link.d.ts
declare const linkFixtures: HtmlFixture[];
//#endregion
//#region src/test-utils/marks.d.ts
declare const markFixtures: HtmlFixture[];
//#endregion
//#region src/test-utils/nodes.d.ts
declare const nodeFixtures: HtmlFixture[];
declare const allNodeFixtures: HtmlFixture[];
//#endregion
//#region src/test-utils/tables.d.ts
declare const tableFixtures: HtmlFixture[];
//#endregion
//#region src/test-utils/index.d.ts
declare const allFixtures: HtmlFixture[];
//#endregion
export { HtmlFixture, allFixtures, allNodeFixtures, customRendererFixture, doc, integrationFixtures, linkFixtures, linkMark, markFixtures, nodeFixtures, table, tableCell, tableFixtures, tableHeader, tableRow, text };
