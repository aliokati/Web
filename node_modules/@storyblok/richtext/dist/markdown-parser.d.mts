...
type ExtensionKey = Extension["type"];
type ExtensionAttrMap = { [E in Extension as E["type"]]: E extends {
  attrs: infer A;
} ? A : E extends {
  attrs?: infer A;
} ? A : undefined; };
type ExtensionAttrs<K extends ExtensionKey> = ExtensionAttrMap[K];
/** Conditional typing for Node vs Mark */
type NodeKey = RichTextNode["type"];
type MarkKey = RichTextMark["type"];
type ParseHTMLReturn<T extends ExtensionKey> = T extends NodeKey ? NonNullable<NodeSpec["parseDOM"]> : T extends MarkKey ? NonNullable<MarkSpec["parseDOM"]> : never;
/** Extension Options */
interface ExtensionOptions<K extends ExtensionKey> {
  parseHTML?: () => ParseHTMLReturn<K> | undefined;
  attributeParsers?: Partial<{ [P in keyof ExtensionAttrs<K>]: (el: HTMLElement) => ExtensionAttrs<K>[P] | null | undefined; }>;
}
//#endregion
//#region src/extensions/index.d.ts
type StoryblokParserOptionsMap = { [K in ExtensionKey]?: ExtensionOptions<K>; };
 ...
 */
declare function mapToAttribute(attributes?: string[] | string, styleProperty?: string): (el: HTMLElement) => string | null;
//#endregion
//#region src/markdown-parser.d.ts
interface MarkdownParserOptions {
  parsers?: HTMLParserOptions["parsers"];
}
declare function markdownToStoryblokRichtext(md: string, options?: MarkdownParserOptions): RichTextFieldValueRoot;
//#endregion
export { MarkdownParserOptions, mapToAttribute, markdownToStoryblokRichtext };
//# sourceMappingURL=markdown-parser.d.mts.map