...
function markdownToStoryblokRichtext(md, options = {}) {
	return htmlToStoryblokRichtext(new MarkdownIt({
		html: false,
		linkify: true,
		typographer: true,
		breaks: true
...
//#endregion
export { mapToAttribute, markdownToStoryblokRichtext };

//# sourceMappingURL=markdown-parser.mjs.map